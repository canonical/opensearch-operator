...
If you are a beginner to OpenSearch or Juju and are looking for a more comprehensive walkthrough of these steps, refer instead to the [Tutorial](/tutorial/index).
...
**System requirements**: Check that you fulfill the rest of the software and hardware requirements in the [system requirements page](/reference/system-requirements).
