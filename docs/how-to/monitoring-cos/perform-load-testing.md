(how-to-guides-monitoring-cos-perform-load-testing)=
...
>  This document uses Microk8s. Installation instructions can be found [in COS documentation](https://charmhub.io/topics/canonical-observability-stack/tutorials/install-microk8s#configure-microk8s).
