...
* [[DP-7928]](https://warthogs.atlassian.net/browse/DPE-7928) block if we fail to get the provider info from the oauth relation [(PR \#218)](https://github.com/canonical/opensearch-dashboards-operator/pull/218)
* [[DPE-6600]](https://warthogs.atlassian.net/browse/DPE-6600) Move away from libjuju's `add_machine` [(PR \#167)](https://github.com/canonical/opensearch-dashboards-operator/pull/167)
...
* [[DPE-6687]][[DPE-6690]][[DPE-6691]](https://warthogs.atlassian.net/browse/DPE-6687) Extend TF charm modules [(PR \#168)](https://github.com/canonical/opensearch-dashboards-operator/pull/168)
