...
* [How to set up a large deployment](/how-to-guides/deploy/launch-a-large-deployment)
...
* [How to enable TLS encryption](/how-to-guides/tls-encryption/enable-tls-encryption)
* [How to rotate TLS/CA certificates](/how-to-guides/tls-encryption/rotate-tls-ca-certificates)
...
* [How to enable monitoring](/how-to-guides/monitoring-cos/enable-cos)
...
* [How to configure S3 storage](/how-to-guides/back-up-and-restore/configure-s3)
* [How to create a backup](/how-to-guides/back-up-and-restore/create-a-backup)
...
See the [system requirements page](/reference/system-requirements) for more information about [software](/reference/system-requirements) and [hardware](/reference/system-requirements) prerequisites.
...
* [TLS certificates charms](https://charmhub.io/topics/security-with-x-509-certificates#understanding-your-x-509-certificates-requirements)
  ...
  * See also: [How to enable TLS](/how-to-guides/tls-encryption/enable-tls-encryption)
