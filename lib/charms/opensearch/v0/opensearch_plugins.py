...
class OpenSearchPluginMLCommons(OpenSearchPlugin):
    ...
    def disable(self) -> OpenSearchPluginConfig:
        ...
        return OpenSearchPluginConfig(
            config_entries_to_add={
                "plugins.ml_commons.remote_inference.enabled": False,
                "plugins.ml_commons.model_access_control_enabled": False,
                "plugins.ml_commons.connector_access_control_enabled": False,
                "plugins.ml_commons.model_auto_redeploy.enable": False,
            },
            config_entries_to_del=[
                ...
                "plugins.ml_commons.max_model_on_node",
                ...
                "plugins.ml_commons.ml_task_timeout_in_seconds",
                "plugins.ml_commons.native_memory_threshold",
                "plugins.ml_commons.allow_custom_deployment_plan",
                "plugins.ml_commons.model_auto_redeploy.lifetime_retry_times",
                "plugins.ml_commons.model_auto_redeploy_success_ratio",
                "plugins.ml_commons.enable_inhouse_python_model",
            ],
        )
