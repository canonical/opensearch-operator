...
class TestOpenSearchTLS(unittest.TestCase):
    ...
    @patch("charm.OpenSearchOperatorCharm._put_admin_user")
    def test_on_relation_joined_admin(self, _put_admin_user, _request_certificate):
    ...
    @patch("charms.opensearch.v0.opensearch_tls.OpenSearchTLS._request_certificate")
    @patch("charm.OpenSearchOperatorCharm._put_admin_user")
    def test_on_relation_joined_non_admin(self, _put_admin_user, _request_certificate):
        """Test on certificate relation joined event."""
        event_mock = MagicMock()
    ...
    @patch("charms.opensearch.v0.opensearch_tls.OpenSearchTLS._request_certificate")
    @patch("charm.OpenSearchOperatorCharm._put_admin_user")
    def test_on_set_tls_private_key(self, _put_admin_user, _request_certificate):
