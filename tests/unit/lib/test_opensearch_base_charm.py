...
class TestOpenSearchBaseCharm(unittest.TestCase):
    ...
    @patch(
        "charms.opensearch.v0.opensearch_relation_provider.OpenSearchProvider.clear_zombie_users_and_roles"
    )
    def test_on_update_status(self, _clear_zombies, get_relation, cert_expiration_remaining_hours):
