...
class DataRelation(Object, ABC):
    ...
    def _fetch_my_specific_relation_data(
        ...
        """Fetch data available (directily or indirectly -- i.e. secrets) from the relation for owner/this_app."""  # noqa
        raise NotImplementedError
...
class DataProvides(DataRelation):
    ...
    def _fetch_specific_relation_data(
        ...
        NOTE: Since all secret fields are in the Provides side of the databag, we don't need to worry about that # noqa
        """
        if not relation.app:
            return {}
