...
from tests.integration.helpers import APP_NAME, MODEL_CONFIG, UNIT_IDS
...
async def test_database_relation_with_charm_libraries(
    ...
    #      will happen simultaneously in bundles, but for now, make sure opensearch is active
    #      before adding client relation.
