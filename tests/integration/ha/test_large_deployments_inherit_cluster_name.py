...
NO_DATA_NODE_STATUS_MESSAGE = "At least 1 data nodes are required. Found only 0."
NO_CM_STATUS_MESSAGE = "At least 1 cluster manager nodes are required. Found only 0."
