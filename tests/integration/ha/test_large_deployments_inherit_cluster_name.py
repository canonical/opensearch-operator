...
async def test_build_and_deploy_not_autogen(ops_test: OpsTest, charm, ubuntu_base) -> None:
...
@pytest.mark.abort_on_fail
@pytest.mark.skip_if_deployed
async def test_build_and_deploy_autogen(ops_test: OpsTest, charm, ubuntu_base) -> None:
