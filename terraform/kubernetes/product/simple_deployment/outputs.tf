...
output "provides" {
  ...
  value = {
    ...
    opensearch_grafana_dashboard = module.opensearch.provides.grafana_dashboard
    opensearch_metrics_endpoint  = module.opensearch.provides.metrics_endpoint
  }
}
...
output "requires" {
  ...
  value = {
    ...
    opensearch_logging           = module.opensearch.requires.logging
