...
This module is intended to be a product module, deploying all components for a proper and large opensearch deployment: a main orchestrator, an optional failover orchestrator and other OpenSearch apps, forming one cluster, optionally across several models.
